            ...
            {otpStage ? (
              ...
              >
                ...
                <div className="relative flex py-3 items-center">
                  ...
                  <span className="shrink-0 px-3 text-[10px] text-slate-500 font-medium">OR</span>
                  <div className="flex-grow border-t border-slate-800"></div>
                </div>
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      const res = await api.googleLogin({ idToken, referralCode: referralCode || undefined });
                      onAuthSuccess(res.token, res.user);
                    } catch (err: any) {
                  ...
                  className="w-full py-3.5 bg-white text-slate-900 font-bold rounded-2xl text-xs tracking-wide transition-all hover:bg-slate-100 active:scale-95 disabled:opacity-50 cursor-pointer flex items-center justify-center gap-2"
                >
